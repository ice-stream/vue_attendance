  ...
  <div style="margin: 25px">
    <el-card style="height: 800px">
      <el-breadcrumb separator-class="el-icon-arrow-right" style="height: 30px">>
        ...
        <el-breadcrumb-item>我要出差</el-breadcrumb-item>
      </el-breadcrumb>
      ...
      <el-table  :data="tableData" border highlight-current-row style="width: 100%">
        ...
        <el-table-column  prop="travelId" label="编号" width="100" ></el-table-column>
      ...
      <el-dialog title="出差申请" :visible.sync="revise" width="65%">
        <el-form :model="form">
  ...
  export default {
    ...
    methods:{
      ...
      search:function () {
        ...
        var _self = this;
        this.$ajax.post('/cms-attendance-web/selectMyTravel',
          qs.stringify(formData)).then(function(result){
          var list = result.data.list;
          _self.total=result.data.page.record*10;
          for(var i=0;i<list.length;i++) {

            list[i].startDate = getDateTime(list[i].startDate);
            list[i].endDate = getDateTime(list[i].endDate);
      ...
      submitForm:function (form) {
        ...
        var qs = require('querystring')
        var _self = this;
        this.$ajax.post('/cms-attendance-web/addTravel',
