  ...
  <div style="margin: 25px">
    <el-card style="height: 800px">
      <el-breadcrumb separator-class="el-icon-arrow-right" style="height: 40px">>
        ...
        <el-breadcrumb-item>我要加班</el-breadcrumb-item>
      </el-breadcrumb>
      <el-form  :inline="true" size="small" :model="formline" label-width="90px">
        ...
        <el-form-item>
          <el-button type="warning" @click="revise = true">申请加班</el-button>
        </el-form-item>
      </el-form>
      ...
      <el-table  :data="tableData" border highlight-current-row style="width: 100%">
        ...
        <el-table-column  prop="overtimeId" label="加班编号" width="150"></el-table-column>
      ...
      <el-dialog title="加班申请" :visible.sync="revise" width="65%">
        <el-form :model="form">
  ...
  export default {
    ...
    methods:{
      ...
      search:function () {
        ...
        var _self = this;
        this.$ajax.post('/cms-attendance-web/selectMyOverTime',
      ...
      submitForm:function (form) {
        ...
        var qs = require('querystring')
        var _self = this;
        this.$ajax.post('/cms-attendance-web/addOverTime',
          qs.stringify(formData)).then((response) => {
          _self.revise = false
          if (response.data.num === 1) {
            this.$message.success('加班成功！')

          } else {
            this.$message.success('加班失败！')
