          ...
          <el-row>
            <el-col>
              <el-card shadow="hover" class="mgb20">
                ...
                <div class="user-info-list">姓名： {{ userName}}</div>
              ...
              <el-col :span="12"  style="width: 1000px;"  >
                <el-menu  router :default-active="$route.path"
                  ...
                  <el-submenu index="1"  >
                    ...
                    <el-menu-item-group>
                      <template slot="title">考勤处理</template>
                  ...
                  <el-submenu index="3" >
                    ...
                    <el-menu-item-group>
                      <template slot="title">巡岗日志</template>
                      <el-menu-item index="/myPatrol">巡岗日志</el-menu-item>
                    </el-menu-item-group>
                    <el-menu-item-group title="巡岗路线">
                      <el-menu-item index="/myLine">巡岗路线</el-menu-item>
                    </el-menu-item-group>
                    <el-submenu index="3-4">
                      <template slot="title">巡岗签到签到</template>
                      <el-menu-item index="/patLogin">打卡签到</el-menu-item>
                    </el-submenu>
                  </el-submenu>
                </el-menu>
              </el-col>
