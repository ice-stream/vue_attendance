  ...
  <div style="margin: 25px">
    <el-card style="height: 800px">
      <el-breadcrumb separator-class="el-icon-arrow-right" style="height: 30px">>
        ...
        <el-breadcrumb-item>加班处理</el-breadcrumb-item>
      </el-breadcrumb>
      ...
      <el-table  :data="tableData" border highlight-current-row style="width: 100%">
        ...
        <el-table-column  prop="overtimeId" label="补签编号" width="150"></el-table-column>
  ...
  export default {
    ...
    methods:{
      ...
      search:function () {
        ...
        var _self = this;
        this.$ajax.post('/cms-attendance-web/selectOverTime',
      ...
      deal(row){
        ...
        var _self = this;
        var qs = require('querystring');
        this.$ajax.post('/cms-attendance-web/dealOverTime',
      ...
      cancel(row){
        ...
        var _self = this;
        var qs = require('querystring');
        this.$ajax.post('/cms-attendance-web/deleteOverTime',
          qs.stringify(formData)).then((response) => {
          _self.revise = false
          if (response.data.num === 1) {
            this.$message.success('提交成功！')
